...
import {
  ...
  IUser,
  UserStaticsMethods,
} from "../interfaces/user_interface/user.interface";
...
const userSchema = new Schema<IUser, UserStaticsMethods>(
  {
    fname: {
      type: String,
      required: true,
...
const User = model<IUser, UserStaticsMethods>("User", userSchema);
export default User;
